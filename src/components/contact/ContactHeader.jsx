  ...
  return (
    <div className="relative text-center max-w-3xl mx-auto mb-8 sm:mb-12">
      ...
      <div className="relative mt-3 sm:mt-4 flex justify-center">
        <div className="relative h-[4px] w-28 sm:w-32 rounded-full overflow-hidden">
        ...
        <div className="-z-10 absolute top-1/2 -translate-y-1/2 w-32 sm:w-40 h-8 sm:h-10 bg-blue-100/50 rounded-full blur-xl" />
      </div>
      ...
      <style>{`
        ...
        @media (max-width:640px){ .animate-gradient{animation-duration:8s;} .animate-sheen{animation-duration:3s;opacity:.25} }
        @media (prefers-reduced-motion: reduce){ .animate-gradient, .animate-sheen{ animation:none } }
      `}</style>
    </div>
  );
}
