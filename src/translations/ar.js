export default {
  ...
  // Hero Section
  heroHighlight1: "نحن نهتم بـ",
  heroHighlight2: "نظافة بيتك",
  heroSubtitle: "نتائج فورية، تنظيف دقيق، وأداء بدون فوضى – جرب الفرق بنفسك.",
...
- تجفيف سريع بدون رائحة`,
  ...
  carTitle: "تنظيف السيارات",
  carDescription: "داخلي وخارجي مع تعقيم.",
...
نستخدم مواد خاصة لكل نوع جلد أو قماش، مع تعقيم بالبخار للمناطق الحساسة.`,
  ...
  carpetDescription: "غسيل وتجفيف السجاد.",
